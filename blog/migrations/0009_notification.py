...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('blog', '0008_messagemodel_threadmodel'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thread', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='blog.threadmodel')),
